...
add_action( 'customize_register', 'edward_blog_color_section' );
function edward_blog_color_section( $wp_customize )
{
    $wp_customize->get_section( 'colors' )->title = esc_html__( "Color Options", 'edward-blog' );
