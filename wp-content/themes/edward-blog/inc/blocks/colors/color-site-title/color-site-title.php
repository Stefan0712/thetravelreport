...
add_action( 'customize_register', 'edward_blog_site_title_color' );
function edward_blog_site_title_color( $wp_customize ) {

	$wp_customize->add_setting( 'site_title_color_option', array(
	    'default'     => edward_blog_get_default_site_title_color(),
	    'transport' => 'postMessage',
	    'sanitize_callback' => 'sanitize_hex_color',
	) );

	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'site_title_color_option', array(
	    'label'      => esc_html__( 'Site Identity Color', 'edward-blog' ),
...
add_action( 'customize_preview_init', 'edward_blog_site_title_color_enqueue_scripts' );
function edward_blog_site_title_color_enqueue_scripts() {
