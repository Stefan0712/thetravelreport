...
add_action( 'customize_register', 'edward_blog_register_post_snippet_customization_section' );
function edward_blog_register_post_snippet_customization_section( $wp_customize ) {

	$wp_customize->add_section( 'edward_blog_post_snippet_customization_section', array(
	    'title'	=> esc_html__( 'Post Snippet', 'edward-blog' ),
	    'priority'	=> 22
	) );
