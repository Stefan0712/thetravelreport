...
add_action( 'customize_register', 'edward_blog_post_detail_author' );
function edward_blog_post_detail_author( $wp_customize ) {

	$wp_customize->add_setting( 'post_detail_hide_show_author', array(
        'sanitize_callback'     =>  'edward_blog_sanitize_checkbox',
        'default'               =>  edward_blog_get_default_post_detail_author()
    ) );
