...
add_action( 'customize_register', 'edward_blog_post_detail_featured_image' );
function edward_blog_post_detail_featured_image( $wp_customize ) {

	$wp_customize->add_setting( 'post_detail_hide_show_featured_image', array(
        'sanitize_callback'     =>  'edward_blog_sanitize_checkbox',
        'default'               =>  edward_blog_get_default_post_detail_featured_image()
    ) );
...
add_action( 'customize_register', 'edward_blog_post_detail_featured_image_size' );
function edward_blog_post_detail_featured_image_size( $wp_customize ) {

    $wp_customize->add_setting( 'post_detail_featured_image_size', array(
        'default'     => edward_blog_get_default_post_detail_featured_image_size(),
    ...
    $wp_customize->add_control( 'post_detail_featured_image_size', array(
        ...
        'active_callback' => function(){
            return get_theme_mod( 'post_detail_hide_show_featured_image', edward_blog_get_default_post_detail_featured_image() );
        },
        'choices'     => array(
