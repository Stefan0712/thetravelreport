...
add_action( 'wp_enqueue_scripts', 'edward_blog_google_fonts_scripts' );
function edward_blog_google_fonts_scripts() {
    $args = edward_blog_used_google_fonts();
    wp_enqueue_style( 'google-fonts', edward_blog_fonts_url( $args ), array(), null );
}