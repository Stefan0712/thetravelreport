...
*/
function edward_blog_is_google_font( $font ){
    $return = false;
    $websafe_fonts = edward_blog_get_websafe_font();
    if( $font ){
...
if( ! function_exists( 'edward_blog_get_websafe_font' ) ) {
    
    /**
     * Function listing WebSafe Fonts and its attributes
    */
    function edward_blog_get_websafe_font(){
        ...
        return apply_filters( 'edward_blog_standard_fonts', $standard_fonts );
    }

}


function edward_blog_used_google_fonts() {
    $main_font_family = get_theme_mod( 'main_font_family', edward_blog_get_default_main_font_family() );
    $secondary_font_family = get_theme_mod( 'secondary_font_family', edward_blog_get_default_secondary_font_family() );
...
add_action( 'wp_loaded', 'edward_blog_google_font_local' );
if( ! function_exists( 'edward_blog_google_font_local' ) ) {
    /**
    ...
    */
    function edward_blog_google_font_local() {

        $args = array();
        $fonts = edward_blog_used_google_fonts();

        foreach( $fonts as $font ) {

            $is_google_font = edward_blog_is_google_font( $font );
        ...
        new Edward_Blog_Webfonts_Local( $args );
...
if( ! function_exists( 'edward_blog_fonts_url' ) ) {
    /**
     * Returns Google Fonts Url
    */ 
    function edward_blog_fonts_url( $fonts = array() ) {
        ...
        foreach( $fonts as $font ) {
            ...
            if( $is_google_font ) {
                $varient = edward_blog_check_varient( $font, 'regular', true );
...
if( ! function_exists( 'edward_blog_check_varient' ) ) {
    /**
     * Checks for matched varients in google fonts for typography fields
    */
    function edward_blog_check_varient( $font_family = 'serif', $font_variants = 'regular', $body = false ){
        $variant = '';
        $var     = array();
        $google_fonts  = edward_blog_get_google_fonts(); //Google Fonts

         if( $google_fonts == false ) {
            $google_fonts = array();
        }
        
        $websafe_fonts = edward_blog_get_websafe_font(); //Standard Web Safe Fonts
...
if( ! function_exists( 'edward_blog_get_google_fonts' ) ) {
    /**
     * Get Google Fonts
    */
    function edward_blog_get_google_fonts(){
