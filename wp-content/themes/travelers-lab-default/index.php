...
<div class="index-header">
    <a href="<?php echo site_url(''); ?>" class="go-home-btn"><div class="dashicons dashicons-admin-home icon"></div> Go home</a>
    <div class="currently-in"><?php the_archive_title(); ?></div>        
